...
public class DatabaseConnection {
  ...
  private static final String JDBC_URL =
    "jdbc:mysql://localhost:3306/database_siswa";
  ...
  public static void main(String[] args) {
    ...
    try {
        ...
        System.out.println("Koneksi ke database telah berhasil.");
        ...
        do {
            ...
            System.out.println(" 4. Tampilkan Daftar Semua Siswa");
            System.out.println(" 5. Keluar");

            System.out.print("Masukkan nomor aksi: ");
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    break;
                default:
                    System.out.println("Gagal. Silakan coba lagi.");
            }
        } while (choice != 5);
    } catch (SQLException e) {
      System.err.println("gagal konek karena" + e.getMessage());
    } finally {
      try {
